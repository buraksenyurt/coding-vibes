        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOffended = table.Column<bool>(type: "boolean", nullable: false),
                    OffendedReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    OffendedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Alarms_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Details_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Type = table.Column<int>(type: "integer", nullable: false),
                    Message = table.Column<string>(type: "character varying(75)", maxLength: 75, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AlarmActions_Alarms_AlarmId",
                        column: x => x.AlarmId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlarmActions_AlarmId",
                table: "AlarmActions",
                column: "AlarmId");

            migrationBuilder.CreateIndex(
                name: "IX_Alarms_PersonId",
                table: "Alarms",
                column: "PersonId");
